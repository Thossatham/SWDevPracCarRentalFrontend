...

            {
                ...
                <form action={addCar}>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type='number' required id='largebags' name='largebags' placeholder="2" min={0} max={50}
                        className="bg-white border-2 border-gray-200 rounded w-auto p-2 
                        text-gray-700 outline-none focus:border-blue-400"/>

                        <label className='w-auto block text gray-700 pr-4 ml-5' htmlFor="smallbags">Small Bags</label>
                        <input type='number' required id='smallbags' name='smallbags' placeholder="2" min={0} max={50}
                        className="bg-white border-2 border-gray-200 rounded w-auto p-2 
                        text-gray-700 outline-none focus:border-blue-400"/>
                    </div>
