...
export default async function CarDetailPage( {params} : {params:{cid:string}} ) {
    ...
    // mockCarRepo.set("001", {name:"Honda Civic", image: "/img/civic.png"})
    // mockCarRepo.set("002", {name:"Honda Accord", image: "/img/accord.png"})
    ...
    return(
        <main className="text-center p-5">
            ...
            <div className="flex flex-row my-5">
                ...
                <div className="text-md mx-5">Large Bags: { carDetail.data.largebag } </div>
